...
*   Pune - 411 028       
*
*   File Name - bacDELDef.h
*
*   AUTHORS
*   Surendra Oturkar
*
*   DESCRIPTION                                                            
*   Defines all enumerations defined by BACnet standard and the stack.
*
*
*********************************************************************************/
...
/****************************************************************************
 **** Bacnet Protocol Property Enums. 
 ****************************************************************************/

/** Bacnet Properties as per ANSI/ASHRAE Standard 135-2010 */
typedef enum {
    ...
    PROP_ISSUE_CONFIRMED_NOTIFICATIONS = 51, /* removed in version 1 revision 4 */
    ...
    PROP_RECIPIENT = 101, /* removed in version 1 revision 4 */
    ...
    PROP_CURRENT_NOTIFY_TIME = 129, /* removed in version 1 revision 3 */
    ...
    PROP_PREVIOUS_NOTIFY_TIME = 138, /* removed in version 1 revision 3 */
	...
	/* enumeration values 216-217 are unassigned in 135-2010 */
	...
	/* enumeration values 223-225 are unassigned in 135-2010 */
    //PROP_FADE_TIME = 223,
	...
	/* enumeration values 236-243 are unassigned in 135-2010 */
    //PROP_OFF_DELAY = 236,
    //PROP_ON_DELAY = 237,
    //PROP_POWER = 238,
    ...
    PROP_MASTER_EXEMPTION = 284, /* removed in version 1 revision 13 */
    ...
    PROP_OCCUPANCY_EXEMPTION = 293, /* removed in version 1 revision 13 */
    ...
    PROP_PASSBACK_EXEMPTION = 299, /* removed in version 1 revision 13 */
	...
	/* enumeration values 312-316 are unassigned in 135-2010 */
	...
	/* enumeration values 324-325 are unassigned in 135-2010 */
	...
	/* enumeration 327-241 is used in Addendum to ANSI/ASHRAE 135-2010 */
    ...
    PROP_BIT_TEXT = 343,
    PROP_IS_UTC = 344,
	/* enumeration 345-351 is used in Addendum to ANSI/ASHRAE 135-2010 */
...
#ifdef BACDEL_PR23
	PROP_DEFAULT_PRESNET_VALUE = 492,
	...
	/* Max supported property */
	MAX_PROP_SUPPORTED,

    /* Proprietory properties for Accumulator object */
    PROP_BACDEL_PROPRIETARY_PULSE_COUNT = 512,
    PROP_BACDEL_PROPRIETARY_PULSE_FREQUENCY = 513,
	/* Proprietory property for Program object */
	PROP_BACDEL_PROPRIETARY_PROGRAM_COUNT = 514,
...
/* enum for backup & restore states */
typedef enum {
...
typedef enum {
	...
	UNITS_DECIBLES = 199,
	UNITS_DECIBLES_MILLIVOLT = 200,
	UNITS_DECIBLES_VOLT = 201,
    UNITS_FARADS = 170,
    UNITS_HENRYS = 171,
    UNITS_OHMS = 4,
	...
	UNITS_EUROPEAN_BITTERING_UNITS = 47819,
...
typedef enum {
	...
	PROP_STATE_LIGHTING_WRITE_STATUS = 37, 
...
typedef enum {
	...
	#ifdef BACDEL_PR14
	RELIABILITY_MONITORED_OBJECT_FAULT = 14,  /* as per 2012 manual */
...
typedef enum {
	...
	EVENT_COMPLEX = 6,		/* -- complex-event-type  (6), see comment below */
	EVENT_UNASSIGNED = 7,   /* -- context tag 7 is deprecated */
    EVENT_CHANGE_OF_LIFE_SAFETY = 8,
    EVENT_EXTENDED = 9,
    EVENT_BUFFER_READY = 10,
    EVENT_UNSIGNED_RANGE = 11,
	EVENT_RESERVED = 12,   /* -- enumeration value 12 is reserved for future addenda */
	...
	EVENT_NONE = 20,
	#endif
    /* Add new event type defined by standard here */
	MAX_EVENT_TYPE
	    /* Enumerated values 0-63 are reserved for definition by ASHRAE.  */
	    /* Enumerated values 64-65535 may be used by others subject to  */
	    /* the procedures and constraints described in Clause 23.  */
...
typedef enum {
    ...
    OBJECT_UNASSIGNED = 31,				/* enum value 31 is unused in protocol */
...
typedef enum {
    ...
    CHARACTER_IBM_MS_DBCS = 1,
    CHARACTER_JISX_0208 = 2,
    CHARACTER_UCS4 = 3,
    CHARACTER_UCS2 = 4,
    CHARACTER_ISO_8859_1 = 5,
...
typedef enum {
    ...
    /* Special Tag Type Definations - Used for properites who have 
                multiple data types */
    BACNET_APPLICATION_TAG_DATETIME = 16,
    BACNET_APPLICATION_TAG_LISTUNSIGN = 17,
    BACNET_APPLICATION_TAG_LISTCHAR = 18,
    BACNET_APPLICATION_TAG_PRIORTYARY = 19,
    BACNET_APPLICATION_TAG_TIMESTAMP = 20,
    BACNET_APPLICATION_TAG_ACTIVECOV = 21,
    BACNET_APPLICATION_TAG_CONSTRUCTED = 22,
    BACNET_APPLICATION_TAG_ANY = 23,

    MAX_BACNET_APPLICATION_TAG, /* Increment as Special Tags increases */
    TAG_NOT_SUPPORTED
...
typedef enum {
	...
	#endif
#ifdef BACDEL_PR23
	/* service added in PR22 i.e. ANSI/ASHRAE 2020 manual */
...
typedef enum {
    ...
    SERVICE_SUPPORTED_CONFIRMED_PRIVATE_TRANSFER = 18,
    SERVICE_SUPPORTED_CONFIRMED_TEXT_MESSAGE = 19,
	...
	#endif
#ifdef BACDEL_PR23
	/* service added in PR23 i.e. ANSI/ASHRAE 2020 manual */
	/* Remote Device Management Services */
...
typedef enum {
    ...
    MAX_BACNET_COMMUNICATION_STATE = 3
} BACNET_COMMUNICATION_STATE;
...
typedef enum {
	...
	NETWORK_MESSAGE_REQUSET_KEY_UPDATE = 13,
...
typedef enum {
    NW_MSG_REJECT_REASON_OTHER = 0,
    NW_MSG_REJECT_REASON_UNKNOWN_DNET = 1,
    NW_MSG_REJECT_REASON_ROUTER_BUSY = 2,
    NW_MSG_REJECT_REASON_UNKNOWN_MSG = 3,
    NW_MSG_REJECT_REASON_MSG_TOO_LONG = 4,
    NW_MSG_REJECT_REASON_SECURITY_ERROR = 5,
    NW_MSG_REJECT_REASON_ADDRESS_ERROR = 6
} BACNET_NW_MSG_REJECT_REASON;
...
typedef enum BACnetLightingOperation {
	BACNET_LIGHTING_OPERATION_NONE = 0,
	BACNET_LIGHTING_OPERATION_FADE_TO = 1,
	BACNET_LIGHTING_OPERATION_RAMP_TO = 2,
	BACNET_LIGHTING_OPERATION_STEP_UP = 3,
	BACNET_LIGHTING_OPERATION_STEP_DOWN = 4,
	BACNET_LIGHTING_OPERATION_STEP_ON = 5,
	BACNET_LIGHTING_OPERATION_STEP_OFF = 6,
	BACNET_LIGHTING_OPERATION_WARN = 7,
	BACNET_LIGHTING_OPERATION_WARN_OFF = 8,
	BACNET_LIGHTING_OPERATION_WARN_RELINQUISH = 9,
	BACNET_LIGHTING_OPERATION_STOP = 10,
	MAX_LIGHTING_OPERATION = 11
...
typedef enum {
    DEVICE_INSTANCE_RANGE_LOW_LIMIT = 0,
    DEVICE_INSTANCE_RANGE_HIGH_LIMIT = 1
}BACNET_DEVICE_INSTANCE_RANGE;

typedef enum{
    LOW_LIMIT_ENABLE = 0,
    HIGH_LIMIT_ENABLE = 1,
	MAX_BACNET_LIMIT_ENABLE
}BACNET_LIMIT_ENABLE;

/* Following enum is used for defining access write of each property */
typedef enum{
    NOT_SUPPORTED = 0,
    READ,
    READ_ONLY,
...
/* Used to specifiy DOB_A context tags */
typedef enum
{
    CONTEXT_TAG_LOWLIMIT = 0,
    CONTEXT_TAG_HIGHLIMIT,
    CONTEXT_TAG_OBJECTID,
    CONTEXT_TAG_OBJECTNAME
}BACNET_DOB_A_CONTEXT_TAGS;

/* Bacnet month of th year for scheduling */
typedef enum {
    BACNET_MONTH_JANUARY = 1,
    BACNET_MONTH_FEBRUARY = 2,
    BACNET_MONTH_MARCH = 3,
    BACNET_MONTH_APRIAL = 4,
    BACNET_MONTH_MAY = 5,
    BACNET_MONTH_JUNE = 6,
    BACNET_MONTH_JULY = 7,
    BACNET_MONTH_AUGUST = 8,
    BACNET_MONTH_SEPTEMBER = 9,
    BACNET_MONTH_OCTOMBER = 10,
    BACNET_MONTH_NOVEMBER = 11,
    BACNET_MONTH_DECEMBER = 12,
    BACNET_MONTH_ODDMONTH = 13,
    BACNET_MONTH_EVENMONTH = 14,
    BACNET_MONTH_ANYMONTH = 255
}BACNET_MONTH;  

/* Week of the month enumeration for scheduling */
typedef enum {
    DAYS_NUM_1_7 =  1,
    DAYS_NUM_8_14 = 2,
    DAYS_NUM_15_21 = 3,
    DAYS_NUM_22_28 = 4,
    DAYS_NUM_29_31 = 5,
    LAST_7_DAYS_OF_MONTH = 6,
    ANY_7_DAYS_PRIOR_TO_LAST_7_DAYS_OF_MONTH = 7,
	ANY_7_DAYS_PRIOR_TO_LAST_14_DAYS_OF_MONTH = 8,
	ANY_7_DAYS_PRIOR_TO_LAST_21_DAYS_OF_MONTH = 9,
    ANY_WEEK_OF_MONTH = 255
}BACNET_WEEK_OF_MONTH;
...
/* Calendar entry status for calendar object */
typedef enum {
    STATUS_DATE = 0,
    STATUS_DATE_RANGE = 1,
    STATUS_WEEK_N_DAY = 2,
...
typedef enum {
    READ_RANGE_ALL = 0,
    READ_RANGE_BY_POSITION = 3,
    /* -- context tag 4 is deprecated */
    /* -- context tag 5 is deprecated */
    READ_RANGE_BY_SEQUENCE_NO = 6,
    READ_RANGE_BY_TIME = 7
}BACNET_READ_RANGE;

/* enum for accumulator status */
typedef enum{
	BACNET_ACC_STATUS_NORMAL = 0,
	BACNET_ACC_STATUS_STARTING = 1,
	BACNET_ACC_STATUS_RECOVERD = 2,
	BACNET_ACC_STATUS_ABNORMAL = 3,
	BACNET_ACC_STATUS_FAILD = 4,
    MAX_BACNET_ACC_STATUS
}BACNET_ACC_STATUS;


/** enum for authentication factor type */
typedef enum{
	AU_FACTOR_TYPE_UNDEFINED = 0,
    AU_FACTOR_TYPE_ERROR = 1,
    AU_FACTOR_TYPE_CUSTOM = 2,
    AU_FACTOR_TYPE_SIMPLE_NUMBER16 = 3,
    AU_FACTOR_TYPE_SIMPLE_NUMBER32 = 4,
    AU_FACTOR_TYPE_SIMPLE_NUMBER56 = 5,
    AU_FACTOR_TYPE_SIMPLE_ALPHA_NUMERIC = 6,
    AU_FACTOR_TYPE_ABA_TRACK2 = 7,
    AU_FACTOR_TYPE_WIEGAND26 = 8,
    AU_FACTOR_TYPE_WIEGAND37 = 9,
    AU_FACTOR_TYPE_WIEGAND37_FACILITY = 10,
    AU_FACTOR_TYPE_FACILITY16_CARD32 = 11,
    AU_FACTOR_TYPE_FACILITY32_CARD32 = 12,
    AU_FACTOR_TYPE_FASC_N = 13,
    AU_FACTOR_TYPE_FASC_N_BCD = 14,
    AU_FACTOR_TYPE_FASC_N_LARGE = 15,
    AU_FACTOR_TYPE_FASC_N_LARGE_BCD = 16,
    AU_FACTOR_TYPE_GSA75 = 17,
    AU_FACTOR_TYPE_CHUID = 18,
    AU_FACTOR_TYPE_CHUID_FULL = 19,
    AU_FACTOR_TYPE_GUID = 20,
    AU_FACTOR_TYPE_CBEFF_A = 21,
    AU_FACTOR_TYPE_CBEFF_B = 22,
    AU_FACTOR_TYPE_CBEFF_C = 23,
    AU_FACTOR_TYPE_USER_PASSWORD = 24,
    MAX_AUTHENTICATION_FACTOR_TYPE = 25
}BACNET_AUTHENTICATION_FACTOR_TYPE;

/** enum for security level */
typedef enum{
	SECURITY_LEVEL_INCAPABLE = 0, //INDICATES THAT THE DEVICE IS CONFIGURED TO NOT USE SECURITY
    SECURITY_LEVEL_PLAIN = 1,
    SECURITY_LEVEL_SIGNED = 2,
    SECURITY_LEVEL_ENCRYPTED = 3,
    SECURITY_LEVEL_SIGNED_END_TO_END = 4,
    SECURITY_LEVEL_ENCRYPTED_END_TO_END = 5,
    MAX_SECURITY_LEVEL = 6
}BACNET_SECURITY_LEVEL;

/** enum for security policy */
typedef enum{
    SECURITY_POLICY_PLAIN_NON_TRUSTED = 0,
    SECURITY_POLICY_PLAIN_TRUSTED = 1,
    SECURITY_POLICY_SIGNED_TRUSTED = 2,
    SECURITY_POLICY_ENCRYPTED_TRUSTED = 3,
    MAX_SECURITY_POLICY = 4
...
/** enum for door secured state */
typedef enum{
    DOOR_SECURED_STATE_SECURED = 0,
    DOOR_SECURED_STATE_UNSECURED = 1,
    DOOR_SECURED_STATE_UNKNOWN = 2,
    MAX_DOOR_SECURED_STATE = 4
}BACNET_DOOR_SECURED_STATE;

/** enum for door alarm state */
typedef enum{
    ...
    MAX_DOOR_ALARM_STATE = 9
}BACNET_DOOR_ALARM_STATE;


/** enum for access event */
typedef enum{
    ACCESS_EVENT_NONE = 0,
    ...
    ACCESS_EVENT_LOCKED_BY_HIGHER_PRIORITY = 9,
    ...
    /* Enumerated values 0-511 are reserved for definition by ASHRAE. */
    /* Enumerated values 512-65535 may be used by others subject to the 
       procedures and constraints described in Clause 23. */
	MAX_BACNET_ACCESS_EVENT
}BACNET_ACCESS_EVENT;

/** enum for access zone occupancy state */
typedef enum{
    ZONE_OCCUPANCY_STATE_NORMAL = 0,
    ZONE_OCCUPANCY_STATE_BELOW_LOWER_LIMIT = 1,
    ZONE_OCCUPANCY_STATE_AT_LOWER_LIMIT = 2,
    ZONE_OCCUPANCY_STATE_AT_UPPER_LIMIT = 3,
    ZONE_OCCUPANCY_STATE_ABOVE_UPPER_LIMIT = 4,
    ZONE_OCCUPANCY_STATE_DISABLED = 5,
    ZONE_OCCUPANCY_STATE_NOT_SUPPORTED = 6,
    /* Enumerated values 0-63 are reserved for definition by ASHRAE. */
    /* Enumerated values 64-65535 may be used by others subject to the 
       procedures and constraints described in Clause 23. */
    MAX_ACCESS_ZONE_OCCUPANCY_STATE = 7
}BACNET_ACCESS_ZONE_OCCUPANCY_STATE;

/** enum for access passback mode */
typedef enum{
    PASSBACK_MODE_PASSBACK_OFF = 0,
    PASSBACK_MODE_HARD_PASSBACK = 1,
    PASSBACK_MODE_SOFT_PASSBACK = 2,
    MAX_PASSBACK_MODE = 3
}BACNET_ACCESS_PASSBACK_MODE;

/** enum for access user type */
typedef enum{
    ...
    /* Enumerated values 64-65535 may be used by others subject to the 
       procedures and constraints described in Clause 23. */
    MAX_ACCESS_USER_TYPE = 3
}BACNET_ACCESS_USER_TYPE;

/** enum for access credential disable reason */
typedef enum{
    ACDR_DISABLED = 0,
    ACDR_DISABLED_NEEDS_PROVISIONING = 1,
    ACDR_DISABLED_UNASSIGNED = 2,
    ACDR_DISABLED_NOT_YET_ACTIVE = 3,
    ACDR_DISABLED_EXPIRED = 4,
    ACDR_DISABLED_LOCKOUT = 5,
    ACDR_DISABLED_MAX_DAYS = 6,
    ACDR_DISABLED_MAX_USES = 7,
    ACDR_DISABLED_INACTIVITY = 8,
    ACDR_DISABLED_MANUAL = 9,
    /* Enumerated values 0-63 are reserved for definition by ASHRAE. */
    /* Enumerated values 64-65535 may be used by others subject to the 
       procedures and constraints described in Clause 23. */
    MAX_ACCESS_CREDENTIAL_DISABLE_REASON = 10
}BACNET_ACCESS_CREDENTIAL_DISABLE_REASON;

/** enum for access credential disable */
typedef enum{
    ACR_NONE = 0,
    ACR_DISABLE = 1,
    ACR_DISABLE_MANUAL = 2,
    ACR_DISABLE_LOCKOUT = 3,
    MAX_ACCESS_CREDENTIAL_DISABLE = 4
}BACNET_ACCESS_CREDENTIAL_DISABLE;

/** enum for type of shed level */
typedef enum{
    SHED_LEVEL_PERCENT = 0,
    SHED_LEVEL_LEVEL = 1,
    SHED_LEVEL_AMOUNT = 2,
    MAX_SHED_LEVEL = 3
}BACNET_SHED_LEVEL;

/** enum for time range specifier */
typedef enum{
    TIME_RANGE_SPECIFIER_SPECIFIED = 0,
    TIME_RANGE_SPECIFIER_ALWAYS = 1,
    MAX_TIME_RANGE_SPECIFIER = 2
}BACNET_TIME_RANGE_SPECIFIER;

/** enum for location specifier */
typedef enum{
    LOCATION_SPECIFIER_SPECIFIED = 0,
    LOCATION_SPECIFIER_ALL = 1,
    MAX_LOCATION_SPECIFIER = 2
}BACNET_LOCATION_SPECIFIER;

/** enum for access authentication factor disable */
typedef enum{
    AAFD_NONE = 0,
    AAFD_DISABLED = 1,
    AAFD_DISABLED_LOST = 2,
    AAFD_DISABLED_STOLEN = 3,
    AAFD_DISABLED_DAMAGED = 4,
    AAFD_DISABLED_DESTROYED = 5,
    /* Enumerated values 0-63 are reserved for definition by ASHRAE. */
    /* Enumerated values 64-65535 may be used by others subject to the 
       procedures and constraints described in Clause 23. */
    MAX_ACCESS_AUTHENTICATION_FACTOR_DISABLE = 6
}BACNET_ACCESS_AUTHENTICATION_FACTOR_DISABLE;

/** enum for Authentication Status */
typedef enum{
    AU_STATUS_NOTREADY = 0,
    AU_STATUS_READY = 1,
    AU_STATUS_DISABLED = 2,
    AU_STATUS_WAITING_FOR_AUTHENTICATION_FACTOR = 3,
    AU_STATUS_WAITING_FOR_ACCOMPANIMENT = 4,
    AU_STATUS_WAITING_FOR_VERIFICATION = 5,
    AU_STATUS_IN_PROGRESS = 6,
    AU_STATUS_MAX = 7
} BACNET_AUTHENTICATION_STATUS;

/** enum for Authentication Mode */
typedef enum{
    ATRZ_MODE_AUTHORIZE = 0,
    ATRZ_MODE_GRANT_ACTIVE = 1,
    ATRZ_MODE_DENY_ALL = 2,
    ATRZ_MODE_VERIFICATION_REQUIRED = 3,
    ATRZ_MODE_AUTHORIZATION_DELAYED = 4,
    ATRZ_MODE_NONE = 5,
    ATRZ_MODE_MAX = 6
}BACNET_AUTHORIZATION_MODE;

/* enum for Authorization Exemption */
typedef enum{
    ATRZ_EXMPTN_PASSBACK = 0,
    ATRZ_EXMPTN_OCCUPANCY_CHECK = 1,
    ATRZ_EXMPTN_ACCESS_RIGHTS = 2,
    ATRZ_EXMPTN_LOCKOUT = 3,
    ATRZ_EXMPTN_DENY = 4,
    ATRZ_EXMPTN_VERIFICATION = 5,
	ATRZ_EXMPTN_AUTHORIZATION_DELAY = 6,
    ATRZ_EXMPTN_MAX = 7
}BACNET_AUTHORIZATION_EXEMPTION;

/** Enumerations for MSTP frame Types */
typedef enum{
	MSTP_FRAME_TYPE_TOKEN = 0,
	MSTP_FRAME_TYPE_PFM = 1,
	MSTP_FRAME_TYPE_RPFM = 2,
	MSTP_FRAME_TYPE_TEST_REQUEST = 3,
	MSTP_FRAME_TYPE_TEST_RESPONSE = 4,
	MSTP_FRAME_TYPE_BACNET_DER = 5,
	MSTP_FRAME_TYPE_BACNET_DNER = 6,
	MSTP_FRAME_TYPE_BACNET_REPLY_POST = 7,
	MAX_MSTP_FRAME_TYPE
}MSTP_FRAME_TYPE;

/** enumerations for Lighting In Progress */
typedef enum{
	BACNET_LIGHTING_IN_PROGRESS_IDLE = 0,
	BACNET_LIGHTING_IN_PROGRESS_FADE_ACTIVE = 1,
	BACNET_LIGHTING_IN_PROGRESS_RAMP_ACTIVE = 2,
	BACNET_LIGHTING_IN_PROGRESS_NOT_CONTROLLED = 3,
	BACNET_LIGHTING_IN_PROGRESS_OTHER = 4,
	MAX_LIGHTING_IN_PROGRESS
}BACNET_LIGHTING_IN_PROGRESS;

/** enumerations for Lighting Transition */
typedef enum{
	BACNET_LIGHTING_TRANSITION_NONE = 0,
	BACNET_LIGHTING_TRANSITION_FADE = 1,
	BACNET_LIGHTING_TRANSITION_RAMP = 2,
	MAX_LIGHTING_TRANSITION
...
/****************************************************************************
 **** BACDEL_STACK Exported Enum Configurations. 
 ****************************************************************************/

/** enum for destination address type in recipient list */
typedef enum{
	DESTINATION_IS_DEVICE_ID = 0,
	DESTINATION_IS_IP_ADDR = 1,
	DESTINATION_IS_LOCAL_BROADCAST = 2,
	DESTINATION_IS_GLOBAL_BROADCAST = 3,
	DESTINATION_IS_REMOTE_BROADCAST = 4,
	DESTINATION_IS_MSTP_DEVICE = 5,
	DESTINATION_IS_UNICAST = 6,
	DESTINATION_IS_UNRECOGNIZED = 7
} DESTINATION_TYPE;

/** enum for type of time stamp */
typedef enum{
    TIMESTAMP_TYPE_TIME = 0,
    TIMESTAMP_TYPE_SEQUENCE_NO = 1,
	TIMESTAMP_TYPE_DATETIME = 2,
    MAX_TIMESTAMP_TYPE
} BACNET_TIMESTAMP_TYPE;

/** Bacnet Data Type Enum Values */
typedef enum {
    BACNET_DT_NULL = 1,                     /* null value */
    BACNET_DT_BOOLEAN,                      /* boolean */
    BACNET_DT_ENUM,                         /* enum value for binary objects */
    BACNET_DT_UNSIGNED32,                   /* unsigned 32 */
    BACNET_DT_UNSIGNED16,                   /* unsigned 16 */
    BACNET_DT_UNSIGNED,                     /* unsigned or unsigned 32 */
    BACNET_DT_INTEGER,                      /* signed or integer */
    BACNET_DT_REAL,                         /* real or float */
    BACNET_DT_DOUBLE,                       /* double */
    BACNET_DT_CHARSTRING,                   /* character string */

	// 11
    BACNET_DT_TIME,							/* time */
    BACNET_DT_DATE,                         /* date */
    BACNET_DT_DATETIME,						/* datetime */
    BACNET_DT_TIMESTAMP_ARRAY,              /* timestamp array */
    BACNET_DT_CHARSTRING_ARRAY,             /* character string array or list */
    BACNET_DT_BITSTRING,                    /* bit string - single byte */
    BACNET_DT_OCTETSTRING,                  /* octet string */
    BACNET_DT_UNSIGNED_ARRAY,               /* unsigned array */
    BACNET_DT_OBJECTID,						/* object id */
    BACNET_DT_OBJTYPE,						/* object type property */

	// 21
    BACNET_DT_BACNETDEVSTAT,                /* device status property */
    BACNET_DT_SERVICES_SUPPORTED,			/* service supported property */
    BACNET_DT_OBJECT_TYPE_SUPPORTED,		/* object type supported property */
    BACNET_DT_OBJECTID_ARRAY,				/* object id array */
    BACNET_DT_BACNETSEG,                    /* segmentation supported property */
    BACNET_DT_BACNETVTCLASS,                /* vt class property */
    BACNET_DT_BACNETVTSESS,                 /* vt session property */
    BACNET_DT_BACNETSESSKEY,                /* sesion key property */
    BACNET_DT_ADDRESSBINDING,               /* address binding */
    BACNET_DT_TIMESTAMP,					/* timestamp */

	// 31
    BACNET_DT_RECIPIENT_PROCESS,			/* recipient process */
    BACNET_DT_DEVOBJPROPREF,				/* device object property reference */
    BACNET_DT_COVSUB,						/* cov subscription */
    BACNET_DT_PRIORITY_ARRAY,				/* priority array */
    BACNET_DT_BOOLEAN_ARRAY,				/* boolean array */
	BACNET_DT_DESTINATION_LIST,				/* destination list */
	BACNET_DT_EVENTPARAMETERS,				/* event parameters */
	BACNET_DT_NOTIFICATIONPRIORITY,         /* priority in NC object */
	BACNET_DT_RECIPIENT_LIST,               /* recipient list */
    BACNET_DT_DATELIST,						/* date list property */

	// 41
    BACNET_DT_DATERANGE,					/* date range - effective period property */
    BACNET_DT_DEVOBJPROPREFF_LIST,			/* list of object property reference */
    BACNET_DT_DAILYSCHEDULE_ARRAY,			/* weekly schedule property */
    BACNET_DT_SPECIALEVENT_ARRAY,           /* exception schedule property */
    BACNET_DT_SCHEDULE_PRESENT_DEFAULT,     /* schedule default */
	BACNET_DT_BACKUPSTATE,                  /* backup & restore state property */
    BACNET_DT_LOGBUFFER_TRENDLOG,           /* log buffer - log record */
    BACNET_DT_LOGBUFFER_LOGSTATUS,          /* log buffer - log status */
    BACNET_DT_LOGBUFFER_ERROR,              /* log buffer - errro */
    BACNET_DT_LOGBUFFER_TIMECHANGE,         /* log buffer - time change */

	// 51
    BACNET_DT_CLIENTCOVINCREMENT,           /* client cov increment property */
	BACNET_DT_OBJPROPREF,					/* object property reference */
    BACNET_DT_SETPOINTREF,					/* setpoint reference */
    BACNET_DT_ENUM_NEW,                     /* enum for enum type properties */
	BACNET_DT_BITSTRING_NEW,                /* bit string - multiple byte */
    BACNET_DT_PRESCALE,                     /* pre scale property */
    BACNET_DT_SCALE,                        /* scale property */
    BACNET_DT_ACCRECORD,                    /* accumulator record */
    BACNET_DT_BITSTRING_ARRAY,              /* bit string array */
    BACNET_DT_ACTION_LIST_ARRAY,            /* action command */

	// 61
    BACNET_DT_READACCESSSPECS_LIST,			/* read access specification */
    BACNET_DT_READACCESSRESULT_LIST,        /* read access result */
    BACNET_DT_PROPERTYACCESSRESULT_ARRAY,   /* property access result */
    BACNET_DT_DEVOBJREFF,                   /* device object reference */
    BACNET_DT_SHEDLEVEL,                    /* shed level */
    BACNET_DT_AUTHENTICATION_FACTOR,        /* authentication factor */
    BACNET_DT_AU_FACTOR_FORMAT_ARRAY,		/* authentication factor format */
    BACNET_DT_OPTIONAL_CHARSTRING,          /* optional character string */
    BACNET_DT_NW_SECURITY_POLICY_ARRAY,     /* network security policy */
    BACNET_DT_SECURITY_KEYSET_ARRAY,        /* security ket set */

	// 71
    BACNET_DT_AUTHENTICATION_POLICY_ARRAY,  /* authentication policy */
    BACNET_DT_ACCESS_RULE_ARRAY,            /* access rule */
    BACNET_DT_CRED_AU_FACTOR_ARRAY,         /* credential authentication factor */
    BACNET_DT_ASSIGNED_ACCESS_RIGHTS_ARRAY, /* assigned access rights */
    BACNET_DT_LOGBUFFER_TLM,                /* log buffer - log record for trend log multiple */
    BACNET_DT_LOGBUFFER_EL,                 /* log buffer - log record for event log */
    BACNET_DT_OPTCHARSTRING_ARRAY,          /* Character string object Optional chara string */
	BACNET_DT_ENUM_LIST,					/* for list of enum type properties */
	BACNET_DT_EVENT_MSG_TEXT,				/* for event message text property */
    BACNET_DT_DEVOBJREFF_LIST,				/* device object reference list */

	// 81
    BACNET_DT_DEVOBJREFF_ARRAY,				/* device object reference array */
	BACNET_DT_DEVOBJPROPREFF_ARRAY,			/* array of device object property referrence */
	BACNET_DT_EMPTY,						/* empty value */
	BACNET_DT_UNSIGNED8,					/* unsigned 8 */
	BACNET_DT_UNSIGNED_LIST,                /* unsigned list */
	BACNET_DT_ADDRESSBINDING_LIST,			/* List of address binding */
	BACNET_DT_DAILYSCHEDULE,				/* single element of daily schedule */
	BACNET_DT_SECURITY_KEYSET,				/* single element of Key sets */
	BACNET_DT_SPECIALEVENT,					/* single element of exception schedule */
	BACNET_DT_PROPERTYACCESSRESULT,			/* single element of property access result array */

	// 91
	BACNET_DT_AU_FACTOR_FORMAT,				/* single element of authentication factor format */
	BACNET_DT_NW_SECURITY_POLICY,			/* single element of network security policy */
	BACNET_DT_AUTHENTICATION_POLICY,		/* single element of authentication policy array */
	BACNET_DT_ACCESS_RULE,		            /* single element of access rule */
	BACNET_DT_CRED_AU_FACTOR,				/* single element of credential au factor */
	BACNET_DT_ASSIGNED_ACCESS_RIGHTS,		/* single element of assigned access rights */
	BACNET_DT_ACTION_LIST,					/* single element of action list */
	BACNET_DT_PROPERTY_LIST,				/* property list */
	BACNET_DT_LIGHTING_COMMAND,				/* lighting command */
	BACNET_DT_RESERVED1,					/* reserved-1 data type */

	// 101
	BACNET_DT_EVENT_NOTIFY_SUBS_LIST,		/* list of event notification subscription */
	BACNET_DT_PROCESS_ID_SELECTION,			/* process id selection */
	BACNET_DT_PORT_PERMISSION,				/* port permission */
	BACNET_DT_PORT_PERMISSION_ARRAY,		/* array of port permission */
	BACNET_DT_CHANNEL_VALUE,				/* channel value */
	BACNET_DT_FAULTPARAMETERS,				/* fault parameters */
	BACNET_DT_ADDRESS,						/* address */
	BACNET_DT_NULL_CONTEXT,					/* null context data-type */
	BACNET_DT_REAL_ARRAY,					/* array of real */
	BACNET_DT_OCTETSTRING_ARRAY,			/* array of octetstring */

	// 111
	BACNET_DT_TIMESTAMP16_ARRAY,			/* timestamp array of 16 */
	BACNET_DT_OPTIONAL_REAL,				/* bacnet optional real */
	BACNET_DT_OPTIONAL_BINARY_PV,			/* bacnet optional binary pv */
	BACNET_DT_OPTIONAL_UNSIGNED,			/* bacnet optional unsigned */
	BACNET_DT_VALUE_SOURCE,					/* value source */
	BACNET_DT_VALUE_SOURCE_ARRAY,			/* value source array of 16 */
	BACNET_DT_NAME_VALUE,					/* name value */
	BACNET_DT_NAME_VALUE_ARRAY,				/* name value array */
	BACNET_DT_NAME_VALUE_COLLECTION,		/* name value collection */
	BACNET_DT_NAME_VALUE_COLLECTION_ARRAY,	/* name value collection array */

	// 121
	BACNET_DT_TIMER_STATE_CHANGE_VAL,		/* single element of timer state change value */
	BACNET_DT_TIMER_STATE_CHANGE_VAL_ARRAY, /* timer state change value array */
	BACNET_DT_LANDING_CALL_STATUS,			/* landing call status */
	BACNET_DT_LANDING_CALL_STATUS_LIST,		/* landing call status list */
	BACNET_DT_ASSIGNED_LANDING_CALL,		/* assigned landing calls */
	BACNET_DT_ASSIGNED_LANDING_CALL_ARRAY,	/* assigned landing calls array */
	BACNET_DT_LIFT_CAR_CALL_LIST,			/* lift car call list */
	BACNET_DT_LIFT_CAR_CALL_LIST_ARRAY,		/* lift car call list array */
	BACNET_DT_LANDING_DOOR_STATUS,			/* landing door status */
	BACNET_DT_LANDING_DOOR_STATUS_ARRAY,	/* landing door status array */

	// 131
	BACNET_DT_HOSTNPORT,					/* bacnet host n port */
	BACNET_DT_BDT_ENTRY,					/* bdt entry */
	BACNET_DT_BDT_ENTRY_LIST,				/* bdt entry list */
	BACNET_DT_FDT_ENTRY,					/* fdt entry */
	BACNET_DT_FDT_ENTRY_LIST,				/* fdt entry list */
	BACNET_DT_VMAC_ENTRY,					/* vmac entry */
	BACNET_DT_VMAC_ENTRY_LIST,				/* vmac entry list */
	BACNET_DT_ROUTER_ENTRY,					/* router entry */
	BACNET_DT_ROUTER_ENTRY_LIST,			/* router entry list */
	BACNET_DT_RESERVED2,					/* reserved-2 data type */

	// 141
	BACNET_DT_COV_MULTIPLE_SUBS,			/* cov multiple subscription */
	BACNET_DT_COV_MULTIPLE_SUBS_LIST,		/* cov multiple subscription list  */
	BACNET_DT_ENUM_ARRAY,					/* enum array */

	/* add stack defined enums above this */
	BACNET_DT_MAX_RESERVED = 511,			/* max reserved data type for stack */
	BACNET_DT_PROPRIETARY_FIRST = 512,		/* first dummy vendor specific data type */

    /* Add new values above this comment */
    BACNET_DT_MAX
} BACNET_DATA_TYPE;

/** Enum defining BACnet Stack therads */
typedef enum
{
    BACNET_DEVICE_PROCESS_THREAD = 1,
    BACNET_NOTIFICATION_THREAD = 2,
    BACNET_COV_B_CANCELLATION_THREAD = 3, 
    BACNET_DCC_THREAD = 4, 
    BACNET_INITIATE_THREAD = 5,
    BACNET_MESSAGE_QUEUE_THREAD = 6,
    BACNET_RECEIVE_THREAD = 7,
    BACNET_SERVICE_THREAD = 8,
    BACNET_PROCESS_THREAD = 9,
    BACNET_TRANSMIT_THREAD = 10,
    BACNET_COV_A_CANCELLATION_THREAD = 11, 
    BACNET_COV_U_NOTIFICATION_THREAD = 12,
    BACNET_DELETION_THREAD = 13,
    BACNET_VD_REQUEST_THREAD = 14,
	BACNET_VD_RESPONSE_THREAD = 15,
	BACNET_ACKNOWLEDGEMENT_THREAD = 16,
	BACNET_SEGMENTATION_THREAD = 17,
	BACNET_CALLBACK_NOTIFICATION_THREAD = 18,
	BACNET_THREADPOOL_THREAD = 19,
	BACNET_CLEAR_INITIATE_QUEUE_THREAD = 20,
    /* Add New Thread enum added in stack here */
    BACNET_ALL_THREAD,
}BACNET_THREADS;

/** Enum defining stack's thread priorities */
typedef enum
{
	BACNET_THREAD_PRIORITY_IDLE = 0,
	BACNET_THREAD_PRIORITY_LOWEST = 1,
	BACNET_THREAD_PRIORITY_BELOW_NORMAL = 2,
    BACNET_THREAD_PRIORITY_NORMAL = 3,
	BACNET_THREAD_PRIORITY_ABOVE_NORMAL = 4,
    BACNET_THREAD_PRIORITY_HIGHEST = 5,
	BACNET_THREAD_PRIORITY_TIME_CRITICAL = 6,
    /* Add new thread priorities as applicable */
    MAX_BACNET_THREAD_PRIORITY
}BACNET_THREAD_PRIORITY;

/** Enum defining stack's max limits parameters */
typedef enum
{
	BACNET_MAXLIMIT_INITIATE_Q_NODES = 1,
	BACNET_MAXLIMIT_BBMD_INITIATE_Q_NODES = 2,
	BACNET_MAXLIMIT_MAX_BDT_FDT_ENTRIES = 3,
    BACNET_MAXLIMIT_MAX_OBJECT = 4,
	BACNET_MAXLIMIT_MAX_DYNAMIC_ADD_BIND = 5,
    BACNET_MAXLIMIT_MAX_COV_SUBS_TX = 6,
	BACNET_MAXLIMIT_MAX_STATE_TEXT = 7,
	BACNET_MAXLIMIT_MAX_AF_VALUES_LIST = 8,
	BACNET_MAXLIMIT_MAX_EX_SCHD_LIST = 9,
	BACNET_MAXLIMIT_MAX_TIME_VALUE_LIST = 10,
	BACNET_MAXLIMIT_MAX_DATE_LIST = 11,
	BACNET_MAXLIMIT_MAX_DESTINATION_LIST = 12,
	BACNET_MAXLIMIT_MAX_DEVOBJPROPREF_LIST = 13,
	BACNET_MAXLIMIT_MAX_EVENT_PARAM_LIST = 14,
	BACNET_MAXLIMIT_MAX_OBJID_LIST = 15,
	BACNET_MAXLIMIT_MAX_ACTIVE_COV_SUBS = 16,
	BACNET_MAXLIMIT_MAX_STATIC_ADD_BIND = 17,
	BACNET_MAXLIMIT_MAX_NW_ANALIZABILITY = 18,
	BACNET_MAXLIMIT_CALLBACK_NOTIFY_Q_NODES = 19,
	BACNET_MAXLIMIT_MAX_FAULT_PARAM_LIST = 20,
	BACNET_MAXLIMIT_MAX_COV_U_LIST = 21,
    /* Add new max limits parameters as applicable */
    MAX_BACNET_MAXLIMIT_PARAMETERS
}BACNET_MAXLIMIT_PARAMETERS;

/** Enum defining default configuration parameters */
typedef enum
{
	BACNET_STACKCONFIGPARAM_THREADPOOL_TIMEOUT = 1,
	BACNET_STACKCONFIGPARAM_CLR_INITIATE_QUE_TIMEOUT = 2,
	BACNET_STACKCONFIGPARAM_CLR_INITIATED_REQ_TIMEOUT = 3,
	BACNET_STACKCONFIGPARAM_PX_QUE_TIMEOUT = 4,
	BACNET_STACKCONFIGPARAM_CLR_INITIATE_QUE_DELETION_COUNT = 5,
	BACNET_STACKCONFIGPARAM_CLR_BBMD_INITIATE_QUE_TIMEOUT = 6,
	/* Add new default configuration parameters as applicable */
    MAX_STACK_CONFIG_PARAMETERS
}BACNET_STACK_CONFIG_PARAMETERS;

/** The HW Interfaces */
typedef enum hwAppFuncChoice
{
    HW_GET_VAL = 0,
    HW_SET_VAL = 1,
	HW_EVENT_NOTIFICATION_CALLBACK = 2,
	HW_REINITIALIZE_DEVICE_CALLBACK = 3,
    HW_DCC_CALLBACK = 4,
    HW_COV_NOTIFICATION_CALLBACK = 5,
	HW_CREATE_OBJECT_CALLBACK = 6,
	HW_DETELE_OBJECT_CALLBACK = 7,
    /* Add new values here */
    MAX_HW_APP_FUNC
}HW_APP_FUNC_CHOICE;

/** Enumeration for status of initiated A-side service request */
typedef enum 
{
    AWAIT_RESPONSE,
    RESPONSE_RECEIVED,
    ERROR_REPONSE,
	/* Add new values here */
    MAX_BACNET_A_SIDE_RESPONSE
}BACNET_A_SIDE_RESPONSE;

/** Enumeration for B-Side callbacks or Auto-Responses */
typedef enum AppInterfaceFuncChoice
{
    APP_CB_READ_PROPERTY = 0,
	APP_CB_READ_PROPERTY_MULTIPLE = 1,
	APP_CB_READ_RANGE = 2,
	APP_CB_WRITE_PROPERTY = 3,
	APP_CB_WRITE_PROPERTY_MULTIPLE = 4,
	APP_CB_ADD_LIST_ELEMENT = 5,
	APP_CB_REMOVE_LIST_ELEMENT = 6,
	APP_CB_CREATE_OBJECT = 7,
	APP_CB_DELETE_OBJECT = 8,
	APP_CB_ATOMIC_READ_FILE = 9,
	APP_CB_ATOMIC_WRITE_FILE = 10,
	APP_CB_SUBSCRIBE_COV = 11,
	APP_CB_SUBSCRIBE_COVP = 12,
	APP_CB_COV_NOTIFICATION = 13,
	APP_CB_EVENT_NOTIFICATION = 14,
	APP_CB_ACKNOWLEDGE_ALARM = 15,
	APP_CB_GET_ALARM_SUMMARY = 16,
	APP_CB_GET_ENROLLMENT_SUMMARY = 17,
	APP_CB_GET_EVENT_INFORMATION = 18,
	APP_CB_DEVICE_COMMUNICATION_CONTROL = 19,
	APP_CB_REINITIALIZE_DEVICE = 20,
	APP_CB_PRIVATE_TRANSFER = 21,
	APP_CB_TEXT_MESSAGE = 22,
	APP_CB_TIME_SYNC = 23,
	APP_CB_UTC_TIME_SYNC = 24,
	APP_CB_WHO_IS = 25,
	APP_CB_WHO_HAS = 26,
	APP_CB_I_AM = 27,
	APP_CB_I_HAVE = 28,
	...
	APP_CB_VT_DATA = 31,
    /* Add new values here */
    MAX_APP_CALLBACK_FUN
}BACAPP_CALLBACK_FUN_CHOICE;

/** enums for callback configurations type */
typedef enum{
    CALLBACK_CONFIG_NOT_REQUIRED = 0,
    CALLBACK_CONFIG_REQUIRED = 1,
    CALLBACK_CONFIG_BEFORE_EXECUTION = 2,
    CALLBACK_CONFIG_AFTER_EXECUTION = 3,
	/* Add new values here */
	MAX_CALLBACK_CONFIG_TYPE
}BACNET_CALLBACK_CONFIG_TYPE;

/** enum for type of callback */
typedef enum{
	CALLBACK_TYPE_NONE = 0,
    CALLBACK_TYPE_SCHEDULING = 1,
    CALLBACK_TYPE_TRENDING = 2,
	CALLBACK_TYPE_COV = 3,
	CALLBACK_TYPE_INTRINSIC_ALARM = 4,
	CALLBACK_TYPE_ALGORITHMIC_ALARM = 5,
	CALLBACK_TYPE_FILE_OPERATION = 6,
	CALLBACK_TYPE_BACKUP_RESTORE_PROCEDURE = 7,
	CALLBACK_TYPE_DCC_STATUS = 8,
	CALLBACK_TYPE_ASIDE_TSM = 9,
	CALLBACK_TYPE_BSIDE_TSM = 10,
	CALLBACK_TYPE_SOCKET_COMMUNICATION_STATUS = 11,
	CALLBACK_TYPE_BBMD = 12,
	CALLBACK_TYPE_NETWORK_LAYER_SERVICE = 13,
	CALLBACK_TYPE_ASIDE_SERVICES = 14,
	CALLBACK_TYPE_BSIDE_SERVICES = 15,
	/* Add new values above this line */
    MAX_CALLBACK_TYPE
} BACNET_CALLBACK_TYPE;

/** enum for callback reason */
typedef enum{
    CALLBACK_REASON_NONE = 0,
    CALLBACK_REASON_SCHEDULE_INTERNAL = 1,
    CALLBACK_REASON_SCHEDULE_EXTERNAL = 2,
	CALLBACK_REASON_TRENDING_INTERNAL = 3,
	CALLBACK_REASON_TRENDING_EXTERNAL = 4,
    CALLBACK_REASON_INITIATING_COV_NOTIFICATION = 5,
	CALLBACK_REASON_INITIATING_EVENT_NOTIFICATION = 6,
	CALLBACK_REASON_FILE_DATA_DELETED = 7,
	CALLBACK_REASON_FILE_DATA_TRUNCATED = 8,
	CALLBACK_REASON_FILE_DATA_EXPANDED = 9,
	CALLBACK_REASON_BNR_BFT_TIMEOUT = 10,
	CALLBACK_REASON_BNR_BPT_TIMEOUT = 11,
	CALLBACK_REASON_BNR_RPT_TIMEOUT = 12,
	CALLBACK_REASON_BNR_RCT_TIMEOUT = 13,
	CALLBACK_REASON_DCC_ENABLED = 14,
	CALLBACK_REASON_DCC_DISABLED = 15,
	CALLBACK_REASON_DCC_DISABLED_INITIATION = 16,
	CALLBACK_REASON_APPLICATIONS_EXCEEDS_TIMEOUT = 17,
	CALLBACK_REASON_ASIDE_TSM_ABORTED = 18,
	CALLBACK_REASON_BSIDE_TSM_ABORTED = 19,
	CALLBACK_REASON_SOCKET_COMMUNICATION_ENABLED = 20,
	CALLBACK_REASON_SOCKET_COMMUNICATION_DISABLED = 21,
	CALLBACK_REASON_TRENDING_BUFFER_HALF_FULL = 22,
	CALLBACK_REASON_TRENDING_BUFFER_FULL = 23,
	CALLBACK_REASON_BDT_UPDATED = 24,
	CALLBACK_REASON_FDT_UPDATED = 25,
	CALLBACK_REASON_NETWORK_NUMBER_IS = 26,
	CALLBACK_REASON_ROUTER_BUSY_TO_NETWORK = 27,
	CALLBACK_REASON_ROUTER_AVAILABLE_TO_NETWORK = 28,
	CALLBACK_REASON_OBJECT_CREATED = 29,
	CALLBACK_REASON_OBJECT_DELETED = 30,
	CALLBACK_REASON_LIST_ELEMENT_ADDED = 31,
	CALLBACK_REASON_LIST_ELEMENT_DELETED = 32,
	/* Add new values above this line */
    MAX_CALLBACK_REASON
} BACNET_CALLBACK_REASON;

/** enum for A-side internal error callback reason */
typedef enum{
	ASIDE_CB_REASON_MALLOC_FAILED = 0,
    ASIDE_CB_REASON_ENCODING_FAILED = 1,
    ASIDE_CB_REASON_SEGMENTATION_NOT_SUPPORTED = 2,
	ASIDE_CB_REASON_UNCONFIRMED_APDU_TOO_LONG = 3,
	/* Add new values above this line */
    MAX_ASIDE_CB_REASON
} BACNET_ASIDE_CALLBACK_REASON;

/** enum for type of callback for log buffer status */
typedef enum{
    LOGBUFFER_CB_REASON_LOG_ENABLED = 0,
    LOGBUFFER_CB_REASON_LOG_DISABLED = 1,
	LOGBUFFER_CB_REASON_LOG_INTERRUPTED = 2,
	LOGBUFFER_CB_REASON_BUFFER_PURGED = 3,
	LOGBUFFER_CB_REASON_BUFFER_FULL = 4,
	LOGBUFFER_CB_REASON_NOTIFICATION_THRESHOLD_REACHED = 5,
	/* Add new enums here */
    MAX_LOGBUFFER_CB_REASON
} BACNET_LOGBUFFER_CB_REASON;

/** Enum for the function Return Types */
typedef enum Return_Type
{
	// -1
    BACDEL_NOT_AVALIABLE = -1,
    BACDEL_SUCCESS = 0,
    BACDEL_CONTINUE,
    BACDEL_ERROR,

	// 3
    BACDEL_DEVICE_NOT_PRESENT,
    BACDEL_TRUNCATED_DATA_FRAME,
    BACDEL_MALLOC_ERROR,
    BACDEL_TAG_ERROR,
    BACDEL_MAX_INSTANCE_ERROR,
    BACDEL_OUT_OF_RANGE_ERROR,
    BACDEL_SEMAPHORE_ERROR,
	BACDEL_MUTEX_ERROR,
	BACDEL_THREAD_ERROR,
    BACDEL_OBJECT_TYPE_ERROR,
    BACDEL_NOT_PROPER_RANGE_ERROR,
    BACDEL_PROPERTY_NOT_PRESENT,
    BACDEL_OBJECT_NOT_PRESENT,
    BACDEL_DUPLICATE_OBJECT,
    BACDEL_DUPLICATE_OBJECT_NAME,

	// 18
	BACDEL_BBMD_NOT_SUPPORTED,
	BACDEL_BBMD_ENABLED,
	BACDEL_BBMD_ALREADY_ENABLED,
	BACDEL_BBMD_DISABLED,
	BACDEL_BBMD_ALREADY_DISABLED,
	BACDEL_FD_ENABLED,
	BACDEL_FD_ALREADY_ENABLED,
	BACDEL_FD_DISABLED,
	BACDEL_FD_ALREADY_DISABLED,

	// 27
    BACDEL_HW_INTERFACE_SUCCESS,
    BACDEL_HW_INTERFACE_NO_MAPPING,
    BACDEL_HW_INTERFACE_NO_PROPERTY,
    BACDEL_HW_INTERFACE_NO_OBJECT,
	BACDEL_HW_INTERFACE_NO_DEVICE,
    BACDEL_HW_INTERFACE_OUT_OF_RANGE_ERROR,

	// 33
    BACDEL_INITIATOR_SUCCESS,
    BACDEL_INITIATOR_ERROR,
    BACDEL_INITIATOR_TIMEOUT,
    BACDEL_INITIATOR_MUTEX_LOCK_FAILED,
    BACDEL_INITIATOR_SEMAPHORE_FAILED,
    BACDEL_INITIATOR_NO_REQUEST_SPACE,
    BACDEL_INITIATOR_NO_INVOKE_ID,
	BACDEL_INITIATOR_NO_TOKEN_ID,
    BACDEL_INITIATOR_MALLOC_ERROR,
    BACDEL_INITIATOR_MAX_OBJECT_TYPE_ERROR,
    BACDEL_INITIATOR_MAX_INSTANCE_ERROR,
    BACDEL_INITIATOR_MAX_PROPERTY_ERROR,
    BACDEL_INITIATOR_BVLC_FUNCTION_ERROR,
    BACDEL_INITIATOR_NOT_PROPER_RANGE_ERROR,
    BACDEL_INITIATOR_UNKNOWN_SERVICE_CHOICE,
    BACDEL_INITIATOR_QUEUE_FULL,
    BACDEL_INITIATOR_UNKOWN_OBJECT_TYPE,
    BACDEL_INITIATOR_INVALID_OBJECT_INSTANCE,
    BACDEL_INITIATOR_INVALID_PROPERTY,
    BACDEL_INITIATOR_CHOICE_ERROR,
    BACDEL_INITIATOR_MAX_CHARACTER_LENGTH_ERROR,
    BACDEL_INITIATOR_INVALID_PROCESS_ID,
    BACDEL_INITIATOR_INVALID_PROPERTY_TAG,

	// 56
	BACDEL_LOCAL_BUFFER_EXCEEDED,
    BACDEL_CODE_PAGE_NOT_SUPPORTED,
    BACDEL_CHARACTER_SET_NOT_SUPPORTED,

	// 59
    BACDEL_INVALID_LICENSE,
    BACDEL_INVALID_MAC_ADDRESS,
    BACDEL_INVALID_IP_ADDRESS,
    BACDEL_INVALID_NETWORK_NO,
    BACDEL_INVALID_PORT_NUMBER,
    BACDEL_SOCKET_INIT_ERROR,
    BACDEL_SOCKET_BIND_ERROR,
    BACDEL_SOCKET_ERROR,
	BACDEL_SOCKET_SEND_ERROR,
    BACDEL_BIP_INIT_ERROR,
    BACDEL_TIMER_ERROR,
    BACDEL_TIMER_Q_ERROR,
    BACDEL_IP_NOT_AVAILABLE,
    BACDEL_IP_PORT_NOT_AVAILABLE,
    BACDEL_PORT_NOT_AVAILABLE,

	// 74
    BACDEL_DIRECTORY_CREATION_FAILED,
    BACDEL_DIRECTORY_PATH_NOT_FOUND,
	BACDEL_OBJECT_CANNOT_BE_DELETED,
	BACDEL_OBJECT_CANNOT_BE_CREATED,
	BACDEL_STACK_NOT_INITIALIZED,
	BACDEL_STACK_ALREADY_INITIALIZED,
	BACDEL_STACK_ALREADY_DE_INITIALIZED,

	// 81
	BACDEL_DESTINATION_NOT_FOUND,
	BACDEL_DESTINATION_INVALID,
	BACDEL_INVALID_INPUT_PARAMETER,
	BACDEL_QUEUE_FULL,
	BACDEL_FILE_CREATION_FAILED,
	BACDEL_FILE_ACCESS_ERROR,
	BACDEL_ROUTER_IP_NOT_FOUND,
	BACDEL_SOCKET_COMMUNICATION_DISABLED,
	BACDEL_DCC_DISABLED,

	// 90
	BACDEL_INVALID_BAUD_RATE,
	BACDEL_SERIAL_INIT_ERROR,
	BACDEL_SERIAL_SEND_ERROR,
	BACDEL_SERIAL_RCV_ERROR,

	// 94
	BACDEL_ENTRY_MESSAGE,
	BACDEL_EXIT_MESSAGE,
	BACDEL_INFORMATIVE_MESSAGE,
	BACDEL_ENCODING_FAILED,
	BACDEL_DECODING_FAILED,

	// 99
	BACDEL_DEVICE_BUSY,
	BACDEL_CONFIGURATION_IN_PROGRESS,
	BACDEL_OPERATIONAL_PROBLEM,
	BACDEL_INTERNAL_ERROR,
	BACDEL_NOT_CONFIGURED,
	BACDEL_PASSWORD_ERROR,
	BACDEL_SECURITY_ERROR,

	// 106
	BACDEL_SEGMENTATION_NOT_SUPPORTED,
	BACDEL_SEGMENTATION_ERROR,
	BACDEL_SEGMENTATION_WINDOW_SIZE_OUT_OF_RANGE,
	BACDEL_DYNAMIC_CREATION_NOT_SUPPORTED,
	BACDEL_DYNAMIC_DELETION_NOT_SUPPORTED,
	BACDEL_OUT_OF_RESOURCES,
	BACDEL_LOG_BUFFER_FULL,
	BACDEL_FILE_FULL,

	// 114
	BACDEL_READ_ACCESS_DENIED,
	BACDEL_WRITE_ACCESS_DENIED,
	BACDEL_PROPERTY_IS_NOT_AN_ARRAY,
	BACDEL_PROPERTY_IS_NOT_A_LIST,
	BACDEL_INVALID_ARRAY_INDEX,
	BACDEL_INVALID_DATA_TYPE,
	BACDEL_INVALID_PARAMETER_VALUE,
	BACDEL_INVALID_CONFIGURATION_DATA,
	BACDEL_DATATYPE_NOT_SUPPORTED,

	// 123
	BACDEL_INCONSISTENT_SELECTION_CRITERION,
	BACDEL_INCONSISTENT_PARAMETERS,
	BACDEL_MISSING_PARAMETER,
	BACDEL_OPTIONAL_FUNCTIONALITY_NOT_SUPPORTED,
	BACDEL_REQUEST_DENIED,
	BACDEL_NO_SPACE_FOR_OBJECT,
	BACDEL_NO_SPACE_FOR_PROPERTY,
	BACDEL_LIST_ELEMENT_NOT_FOUND,
	BACDEL_UNKNOWN_SUBSCRIPTION,

	// 132
	BACDEL_BBMD_INITIATOR_QUEUE_FULL,
	BACDEL_RECEIVE_QUEUE_FULL,
	BACDEL_PROCESS_QUEUE_FULL,
	BACDEL_CALLBACK_NOTIFICATION_QUEUE_FULL,
	BACDEL_PROPERTY_ACCESS_ERROR,
	BACDEL_SERVICE_EXECUTION_ERROR,
	BACDEL_SEGMENT_OUT_OF_ORDER,
	BACDEL_MESSAGE_QUEUE_ERROR,
	BACDEL_DEVICE_PROCESS_QUEUE_FULL,
	BACDEL_VIRTUAL_DEVICE_QUEUE_FULL,
	BACDEL_RESPONSE_QUEUE_FULL,
	BACDEL_RESPONSE_NOT_REQUIRED,

	/* add new enumerations above this */
    BACDEL_OTHER
...
typedef enum{
    ...
    APP_CB_RTC_WRITE = 1,
	APP_CB_RTC_MAX
} BACNET_RTC_CALLBACK_CHOICE;

#ifdef BACDEL_OBJ_NP
/** enumerations for IP mode */
typedef enum {
	IP_MODE_NORMAL = 0,
	IP_MODE_FOREIGN = 1,
	IP_MODE_BBMD = 2,
...
/** enumerations for Router status */
typedef enum {
	ROUTER_STATUS_AVAILABLE = 0,
	ROUTER_STATUS_BUSY = 1,
	ROUTER_STATUS_DISCONNECTED = 2,
	MAX_ROUTER_STATUS
}BACNET_ROUTER_STATUS;

/** enumerations for network number quality */
typedef enum {
	NETWORK_NUMBER_QUALITY_UNKNOWN = 0,
	NETWORK_NUMBER_QUALITY_LEARNED = 1,
	NETWORK_NUMBER_QUALITY_LEARNED_CONFIGURED = 2,
	NETWORK_NUMBER_QUALITY_CONFIGURED = 3,
	MAX_NETWORK_NUMBER_QUALITY
}BACNET_NETWORK_NUMBER_QUALITY;

/** enumerations for network port command */
typedef enum {
	...
	NETWORK_PORT_COMMAND_RENEW_AUTONEGOTIATION = 5,
	NETWORK_PORT_COMMAND_DISCONNECT = 6,
	NETWORK_PORT_COMMAND_RESTART_PORT = 7,
	MAX_NETWORK_PORT_COMMAND
...
/** enumerations for protocol level */
typedef enum {
	PROTOCOL_LEVEL_PHYSICAL = 0,
	PROTOCOL_LEVEL_PROTOCOL = 1,
	PROTOCOL_LEVEL_BACNET_APPLICATION = 2,
	PROTOCOL_LEVEL_NON_BACNET_APPLICATION = 3,
	MAX_PROTOCOL_LEVEL
