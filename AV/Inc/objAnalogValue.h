...
*   09/08/2011   Ashish Verma       Modified analogvalue_t structure.
******************************************************************************/
...
*                                                                      
*DESCRIPTION 
*   BACnet Analog Value Required & Optional Properties.
*   
*/
typedef struct analogvalue
{
