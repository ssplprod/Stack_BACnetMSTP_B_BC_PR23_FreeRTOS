...
void Clear_Process_Info(processInfo_t* pstProcessQData)
{
		...
		NULL != pstProcessQData->m_stProcessData.m_stAPDU.m_pvServiceRequestData)
	{
		...
		{
#if (defined BACDEL_SER_DS_RPM_A || defined BACDEL_SER_DS_WPM_A)
		case SERVICE_SUPPORTED_READ_PROP_MULTIPLE:
		case SERVICE_SUPPORTED_WRITE_PROP_MULTIPLE:
			 /* Clear link list for parameters for Multiple property RW */
			 Free_Service_Memory(pstProcessQData->m_stProcessData.m_stAPDU.
        ...
        case SERVICE_SUPPORTED_READ_PROPERTY:
            {
                ...
                pstRpData = pstProcessQData->m_stProcessData.m_stAPDU.m_pvServiceRequestData;
                if(NULL != pstRpData)
                {
                    /* reset pointer */
                    pstProcessQData->m_stProcessData.m_stAPDU.m_pvServiceRequestData = NULL;
                    /* free buffer allocated to save hex data */
