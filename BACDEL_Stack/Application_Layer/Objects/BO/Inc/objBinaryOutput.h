...
*
*  DESCRIPTION
*   Header file with all supported definations/declarations form Binary_Output.c
*
*  RELEASE HISTORY
...
*                                       2. MAX_PRIORITY_VAL moved to propertydef.h
*   12-07-2011           M.Venu         1. Updated comments in sync with 
*                                          objDevice.h header
*   13-07-2011           M.Venu         Binary Output Structure members updated 
...
*   09-08-2011           Ashish Verma   Modified BinaryOutput_t structure.
...
/** 
@file objBinaryOutput.h Contain all definations/declarations of Binary_Output.c
                      file
*/
...
* 
*DESCRIPTION 
*   BACnet Binary Output structure with All its properties
*   
*/
typedef struct BinaryOutput
{
    ...
    /** Type of Device connected as BO*/
    Pr_BACnetCharStr_t			m_stDeviceType;  
    
    /**Text to display when BO Inactive*/
    Pr_BACnetCharStr_t			m_stInactive_Text;
    
    /** Text to display when BO Active*/
	...
	/** Feedback value from which the PV must differ before an event is 
        generated */
    Pr_BinaryEnumPV_t			m_stFeedbackValue; 
