...
*	03-08-2011			 Prashant Badgujar	Commenting Add_Ai_Object API.
*
*************************************************************************/

/** 
@file analoginput.c Handles Services supported for Binary Input Object
*/
...
const int32_t ai32AnalogInputReqProp[] = 
{
...
const int32_t ai32AnalogInputOptProp[] = 
{
		PROP_DESCRIPTION,
		PROP_DEVICE_TYPE,
		PROP_RELIABILITY,
...
const int32_t ai32AnalogInputProProp[] = 
{
    ENDOFPROPLIST
};

const char *BN_AI_OBJ_Name[]= { BN_AI_0_OBJ_NAME ,	BN_AI_1_OBJ_NAME};
                                 ...
                                 int32_t **pi32Proprietary)
{
	/* function entry */
	#ifdef DEBUG_PRINTF
	Print_DebugMsg(DEBUG_LEVEL3,"BACnetStackAppLayer: Analog_Input_Property_Lists: entry \r\n");
	#endif

    if (pi32Required) 
    {
        *pi32Required = (int32_t *)ai32AnalogInputReqProp;
    }
    if (pi32Optional) 
    {
        *pi32Optional = (int32_t *)ai32AnalogInputOptProp;
    }
    if (pi32Proprietary) 
    {
        *pi32Proprietary = (int32_t *)ai32AnalogInputProProp;
    }

	/* function exit */
	#ifdef DEBUG_PRINTF
	Print_DebugMsg(DEBUG_LEVEL3,"BACnetStackAppLayer: Analog_Input_Property_Lists: exit \r\n");
	#endif
